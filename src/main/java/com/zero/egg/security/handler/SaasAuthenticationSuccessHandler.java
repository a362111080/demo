...
/**
 * @ClassName SaasAuthenticationSuccessHandler
 * @Author lyming
 * @Date 2019/9/27 5:03 下午
 **/
@Component
@Slf4j
public class SaasAuthenticationSuccessHandler extends SavedRequestAwareAuthenticationSuccessHandler {
    @Autowired
